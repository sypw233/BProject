...
actual class LocalStorage {
    ...
    actual suspend fun saveString(key: String, value: String) {
        try {
            ...
            println("Failed to save string to localStorage$e")
        }
    }
    ...
    actual suspend fun getString(key: String): String? {
        return try {
            ...
            println("Failed to get string from localStorage$e")
            null
        }
    }
    ...
    actual suspend fun saveBoolean(key: String, value: Boolean) {
        try {
            ...
            println("Failed to save boolean to localStorage$e")
        }
    }
    ...
    actual suspend fun getBoolean(key: String, defaultValue: Boolean): Boolean {
        return try {
            ...
            println("Failed to get boolean from localStorage$e")
            defaultValue
        }
    }
    ...
    actual suspend fun saveInt(key: String, value: Int) {
        try {
            ...
            println("Failed to save int to localStorage$e")
        }
    }
    ...
    actual suspend fun getInt(key: String, defaultValue: Int): Int {
        return try {
            ...
            println("Failed to get int from localStorage$e")
            defaultValue
        }
    }
    ...
    actual suspend fun saveLong(key: String, value: Long) {
        try {
            ...
            println("Failed to save long to localStorage$e")
        }
    }
    ...
    actual suspend fun getLong(key: String, defaultValue: Long): Long {
        return try {
            ...
            println("Failed to get long from localStorage$e")
            defaultValue
        }
    }
    ...
    actual suspend fun remove(key: String) {
        try {
            ...
            println("Failed to remove item from localStorage$e")
        }
    }
    ...
    actual suspend fun clear() {
        try {
            ...
            println("Failed to clear localStorage"+e)
        }
    }
    ...
    actual suspend fun contains(key: String): Boolean {
        return try {
            ...
            println("Failed to check key in localStorage"+e)
            false
        }
    }
}